...
CREATE TABLE `graces_activity_log` (
  `activity_log_aid` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `graces_customer` (
  `customer_aid` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `graces_products` (
  `products_aid` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `graces_roles` (
  `role_aid` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `graces_sales_order` (
  `sales_order_aid` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `graces_stock_movement` (
  `stock_movement_aid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`stock_movement_aid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `graces_suppliers` (
  `suppliers_aid` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `graces_suppliers_product` (
  `suppliers_product_aid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`suppliers_product_aid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `graces_suppliers_purchase_order` (
  `purchase_order_aid` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`purchase_order_aid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `graces_user_account` (
  `user_account_aid` int(11) NOT NULL AUTO_INCREMENT,
